...
//get high score from locar Storage

let highScore = localStorage.getItem('high-score') || 0;
highScoreElement.innerHTML = `High Score: ${highScore}`;

//get a random between 1 and 30 as food position
...
constrols.forEach(button => button.addEventListener("click", () => changeDirection ({key:button.CDATA_SECTION_NODE.key})));
...
const initGame = () => {
    ...
    for(let i = 0; i < snakeBody.length; i++) {
        ...
        // check nake head hit body or no
